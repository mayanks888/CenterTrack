...
class opts(object):
  def __init__(self):
    ...
    self.parser.add_argument('--task', default='tracking,ddd,multitask', help='ctdet | ddd | multi_pose | tracking or combined with ,')
    ...
    self.parser.add_argument('--load_model', default='../models/model_25.pth',
